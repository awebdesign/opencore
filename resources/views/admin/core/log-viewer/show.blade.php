            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    ...
                    <div class="group-btns pull-right">
                        <a href="{{ route('admin::core.logs.download', [$log->date]) }}" class="btn btn-xs btn-success">
                ...
                <div class="panel-footer">
                    {{-- Search --}}
                    <form action="{{ route('admin::core.logs.search', [$log->date, $level]) }}" method="GET">
                            ...
                            <div class="input-group">
                                ...
                                <span class="input-group-btn">
                                    @unless (is_null($query))
                                        <a href="{{ route('admin::core.logs.show', [$log->date]) }}" class="btn btn-default">
...
@section('modals')
    ...
    <div id="delete-log-modal" class="modal fade">
        <div class="modal-dialog">
            <form id="delete-log-form" action="{{ route('admin::core.logs.delete') }}" method="POST">
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        if (data.result === 'success') {
                            ...
                            location.replace("{{ route('admin::core.logs.list') }}");
                        }
                        else {
