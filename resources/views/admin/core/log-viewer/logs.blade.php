                    ...
                    <tr>
                        @foreach($row as $key => $value)
                            <td class="{{ $key == 'date' ? 'text-left' : 'text-center' }}">
                                ...
                                @else
                                    <a href="{{ route('admin::core.logs.filter', [$date, $key]) }}">
                        ...
                        @endforeach
                        <td class="text-right">
                            <a href="{{ route('admin::core.logs.show', [$date]) }}" class="btn btn-xs btn-info">
                                <i class="fa fa-search"></i>
                            </a>
                            <a href="{{ route('admin::core.logs.download', [$date]) }}" class="btn btn-xs btn-success">
