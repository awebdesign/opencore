            ...
            <thead>
                <tr>
                    ...
                    <th class="{{ $key == 'date' ? 'text-left' : 'text-center' }}">
                        @if ($key == 'date')
                            <span class="label label-info">{{ $th }}</span>
                        @else
                            <span class="level level-{{ $key }}">
                                {!! log_styler()->icon($key) . ' ' . $th !!}
                            </span>
                        @endif
                    </th>
                    @endforeach
                    ...
                    <tr>
                        @foreach($row as $key => $value)
                            <td class="{{ $key == 'date' ? 'text-left' : 'text-center' }}">
                                ...
                                @else
                                    <a href="{{ route('developer::admin.logs.filter', [$date, $key]) }}">
                        ...
                        @endforeach
                        <td class="text-right">
                            <a href="{{ route('developer::admin.logs.show', [$date]) }}" class="btn btn-xs btn-info">
                                <i class="fa fa-search"></i>
                            </a>
                            <a href="{{ route('developer::admin.logs.download', [$date]) }}" class="btn btn-xs btn-success">
