            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    ...
                    <div class="group-btns pull-right">
                        <a href="{{ route('developer::admin.logs.download', [$log->date]) }}" class="btn btn-xs btn-success">
                ...
                <div class="panel-footer">
                    {{-- Search --}}
                    <form action="{{ route('developer::admin.logs.search', [$log->date, $level]) }}" method="GET">
                            ...
                            <div class="input-group">
                                ...
                                <span class="input-group-btn">
                                    @unless (is_null($query))
                                        <a href="{{ route('developer::admin.logs.show', [$log->date]) }}" class="btn btn-default">
                            ...
                            @empty
                                <tr>
                                    <td colspan="5" class="text-center">
                                        <span class="label label-default">{{ trans('admin::core.general.empty-logs') }}</span>
                                    </td>
                                </tr>
                            @endforelse
                        </tbody>
...
@section('modals')
    ...
    <div id="delete-log-modal" class="modal fade">
        <div class="modal-dialog">
            <form id="delete-log-form" action="{{ route('developer::admin.logs.delete') }}" method="POST">
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        if (data.result === 'success') {
                            ...
                            location.replace("{{ route('developer::admin.logs.list') }}");
                        }
                        else {
