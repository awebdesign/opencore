...
namespace OpenCore\Support\Modules;
...
class ModuleManager
{
    ...
    public function all()
    {
        ...
        foreach ($modules as $module) {
            ...
            $package = $this->packageVersion->getPackageInfo("laravel/$moduleName-module");
    ...
    {
        $coreModules = $this->config->get('opencore.coreModules');
